---
title: "LLMMiddleware and AsyncLLMMiddleware"
---
...
<Tabs>
<TabItem value="decorator" label="Decorator">
...
<Tabs>
<TabItem value="explicit-wrapping" label="Explicit wrapping">
...
<Tabs>
<TabItem value="using-decorate-" label="Using decorate()">
...
<Tabs>
<TabItem value="async-function" label="Async function">
...
<Tabs>
<TabItem value="sync-function-auto-detected-" label="Sync function (auto-detected)">
